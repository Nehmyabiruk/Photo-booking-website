...
const team = [
  { name: 'misikir',  role: 'Lead Photographer & Founder',  desc: 'With 10+ years behind the lens, Amen brings artistic vision and cultural depth to every shoot — specializing in weddings and cultural events.' },
  { name: 'Kaleb',  role: 'Lead Videographer' , desc: "Samuel crafts cinematic wedding films and event highlights with a storyteller's eye and an editor's precision." },
  { name: 'krysty',  role: 'Senior Photo Editor',desc: 'Hiwot transforms raw captures into polished masterpieces, ensuring every gallery delivered exceeds client expectations.' },
];
